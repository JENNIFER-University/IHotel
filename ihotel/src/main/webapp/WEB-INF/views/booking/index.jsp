...
<%
	...
	String roomNoString  	= request.getParameter("roomNo");
%>
<div class="container">

<h1 class="title">Booking: <%= room.getRoomType().getRoomType() %></h1>
...
<div class="room-features">
	...
	<div class="row">
		<form action="do_book.do" method="post">
		...
		<div class="panel panel-info">
			...
			<input type="hidden" name="roomNo" value="<%=roomNoString%>"/>
		...
		<div class="panel panel-info">
			...
			<ul class="list-group">
				<li class="list-group-item"><strong>Room Type:</strong> <%= room.getRoomType().getRoomType() %> </li>
				<li class="list-group-item"><strong>Price Per Night :</strong> <%= room.getPrice() %> </li>
			</ul>
			...
			<div class="panel-footer">
				...
				<a href="cancel.do" class="btn btn-danger" id="cancelBooking"><i class="fa fa-times"></i> Cancel Booking</a>
				
				<div class="pull-right">
					<a id="autoFill" href="javascript:void(0)" onclick="autoFill();"><i class="fa fa-lock"></i></a>
					<a id="autoFill500" href="javascript:void(0)" onclick="autoFill500();"><i class="fa fa-unlock-alt"></i></a>
				</div>
			</div>
		</div>
